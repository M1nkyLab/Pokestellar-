...
<div class="max-w-4xl mx-auto mt-24 p-6 bg-white rounded-lg shadow-lg">
            ...
            <?php else: ?>
                <?php foreach ($_SESSION['cart'] as $id => $item): ?>
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center">$<?= number_format($item['price'] * $item['quantity'], 2) ?></td>
                        <td class="border border-gray-300 px-4 py-2 text-center">
    ...
    <div class="text-right mt-4">
        <p class="text-xl font-semibold">Total: <span class="text-red-600">$<?= number_format($total, 2) ?></span></p>
    </div>
